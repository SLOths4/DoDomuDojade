...
final readonly class DatabaseService
{
    ...
    public function bindParams(PDOStatement $stmt, array $params): void
    {
        foreach ($params as $key => $param) {
            ...
            try {
                ...
                throw DatabaseException::parameterBindingFailed($key, $e);
            }
        }
    ...
    public function executeStatement(string $query, array $params = []): PDOStatement
    {
        try {
            ...
            throw DatabaseException::executionFailed($query, $e);
        }
    }
    ...
    public function getTableColumns(string $table): array
    {
        ...
        try {
            ...
            throw DatabaseException::invalidColumns($table);
        }
    }
    ...
    public function validateColumns(string $table, array $data): bool
    {
        ...
        if (!empty($invalidColumns)) {
            ...
            throw DatabaseException::invalidColumns($table, $invalidColumns);
        }
    ...
    {
        if (empty($data)) {
            throw DatabaseException::emptyUpdateData();
        }
    ...
    public function delete(
        ...
        if (empty($conditions) && empty($additionalWhere)) {
            throw DatabaseException::emptyDeleteConditions();
        }
