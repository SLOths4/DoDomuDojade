...
<form method="POST" action="panel/add_coutdown" class="mb-6 p-4 bg-white rounded shadow">
    <div class="mb-2">
        <label>
            ...
            <tr>
                ...
                <td class="px-4 py-2 border space-x-2">
                    ...
                    <form method="POST" action="/panel/delete_countdown" class="delete-form inline">
                        <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(SessionHelper::get('csrf_token')) ?>">
                        <input type="hidden" name="announcement_id" value="<?= htmlspecialchars($countdown['id']) ?>">
                    ...
                    <form method="POST" name="edit_announcement" action="/panel/edit_countdown" class="inline">
                        <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(SessionHelper::get('csrf_token')) ?>">
                        <input type="hidden" name="announcement_id" value="<?= htmlspecialchars($countdown['id']) ?>">
