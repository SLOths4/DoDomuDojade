...
<html lang="pl">
    ...
    <body class="flex flex-col min-h-screen text-center dark:bg-gray-800 dark:text-white">
        <main class="flex-grow">
            ...
            <form class="max-w-sm mx-auto dark:bg-gray-900 dark:text-white" method="POST" action="panel/authenticate">
                <div class="mb-5">
                    <label for="username" class="block mb-23 text-sm font-medium text-gray-900 dark:text-white">Username</label>
