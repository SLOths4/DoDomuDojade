...
<div id="navbar" class="my-2 mx-1 p-2 sticky top-0 right-0 left-0 flex z-10 bg-white dark:bg-gray-800 items-center rounded-2xl">
    ...
    <div id="profile" class="absolute right-0 z-10 max-w-md origin-top-right bg-white dark:bg-gray-800 flex items-center rounded-2xl mr-2">
        ...
        <div x-data="dropdown()">
            <div class="mx-2 pr-2">
                <button x-bind="dropdownToggle" type="button" class="items-center justify-center w-full rounded-lg px-2 py-2 hover:text-primary-400 dark:text-white dark:hover:text-primary-200" id="menu-button" aria-expanded="true" aria-haspopup="true"><?= e(isset($user) ? $user->username : 'Gościu') ?></button>
            </div>
